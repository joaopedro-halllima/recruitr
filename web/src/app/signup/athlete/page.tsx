  ...
  return (
    <main className="theme-content min-h-screen bg-neutral-950 px-6 py-12 text-[var(--app-text)]">
      <div className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-white/5 p-8">
        <div className="text-xs uppercase tracking-wider text-pink-300">Athlete Signup</div>
        <h1 className="mt-2 text-3xl font-semibold">Create your athlete account</h1>
        <p className="mt-2 text-sm text-neutral-400">
          Build your public profile and start posting highlights coaches can discover.
        </p>
